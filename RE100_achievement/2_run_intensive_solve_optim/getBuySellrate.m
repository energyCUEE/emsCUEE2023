function [Buy_rate,Sell_rate] = getBuySellrate(fs,Horizon,TOU_CHOICE)
   
    start_date = '2023-03-31'; % just a starting point any day is fine
    t1 = datetime(start_date); t2 = t1 + Horizon; 
    ...
    % times
        ...
        Sell_rate(vechour >= 18 & vechour <= 22) = 2.7 ;
