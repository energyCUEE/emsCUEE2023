DA_sol = readtable('rolling_solution/dayAhead_sol_20231101_20231104_notrack.csv',ReadRowNames=true);
HA_sol = readtable('rolling_solution/Intraday_sol_20231101_20231104_notrack.csv',ReadRowNames=true);
DA_sol.cumexpense = cumsum(DA_sol.u1);
HA_sol.cumexpense = cumsum(HA_sol.u1);
Actual_PL = readtable('historical/load_data_5minresample_concat.csv',ReadRowNames=true);
Actual_PV = readtable('historical/pv_data_5minresample_concat.csv',ReadRowNames=true);
%%
